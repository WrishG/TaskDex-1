...
const style = {
  ...
  input: "w-full p-3 rounded-lg bg-gray-700 border-2 border-gray-600 text-white focus:border-red-500 focus:ring-2 focus:ring-red-500 placeholder-gray-400",
};
...
function TaskStartModal({ task, onStart, onCancel, getTypeButtonColor }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-8 rounded-2xl max-w-md w-full mx-4 border-2 border-gray-700 shadow-2xl">
        <h3 className="text-3xl font-bold mb-4 text-white text-center">{task.name}</h3>
        ...
        {task.description && (
          <p className="text-gray-400 mb-6 text-center">{task.description}</p>
        )}
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4 bg-[#1a1a1a] text-white animate-fadeIn">
      ...
      <div className={style.card + " max-w-4xl w-full mt-8"}>
        ...
        {showWelcome && (
          <div className="mb-6 p-4 bg-gray-900 border-2 border-red-500 rounded-xl">
            <div className="flex justify-between items-start">
              ...
              <button
                ...
                className="text-gray-500 hover:text-gray-400 text-xl font-bold"
              >
                ×
              </button>
            </div>
        ...
        <div className="space-y-4" role="list" aria-label="Task list">
          {(!tasks || tasks.length === 0) ? (
            <div className="text-center py-12 bg-gray-900 rounded-lg border-2 border-gray-700" role="status">
              <p className="text-gray-400 text-lg">No tasks yet. Click "Add Task" to create your first task!</p>
            </div>
          ) : (
            tasks.map(task => {
              ...
              return (
                <div
                  ...
                  role="listitem"
                  tabIndex={0}
                  className={`pokemon-card p-6 rounded-xl border-2 cursor-pointer focus-ring hover-lift ${typeBorderClass} ${typeBgClass} ${typeHoverClass} hover:ring-4 ${typeRingClass} hover:shadow-xl ${
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      {task.description && (
                        <p className="text-white opacity-90 mt-2">{task.description}</p>
                      )}
                    </div>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-gray-800 p-8 rounded-2xl max-w-lg w-full mx-4 border-2 border-gray-700 shadow-2xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-gray-400 mb-2">Task Name:</label>
                <input
                  type="text"
                  value={taskName}
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-400 mb-2">Task Type:</label>
